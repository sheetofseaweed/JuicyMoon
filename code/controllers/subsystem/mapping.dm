...
/datum/controller/subsystem/mapping/proc/LoadGroup(list/errorList, name, path, files, list/traits, list/default_traits, silent = FALSE, orientation = SOUTH)
	...
	for (var/file in files)
		var/full_path = "_maps/_mod_juicy/[path]/[file]"
...
/datum/controller/subsystem/mapping/proc/preloadTemplates(path = "_maps/_mod_juicy/templates/") //see master controller setup
