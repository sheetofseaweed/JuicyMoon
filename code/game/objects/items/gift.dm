...
/obj/item/a_gift/suicide_act(mob/user)
	user.visible_message("<span class='suicide'>[user] peeks inside [src] and cries themself to death! It looks like [user.ru_who()] [user.p_were()] on the naughty list...</span>")
	return (BRUTELOSS)
