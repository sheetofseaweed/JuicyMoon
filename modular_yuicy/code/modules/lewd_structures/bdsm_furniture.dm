...
/obj/structure/bed/bdsm_bed
	...
	icon = 'modular_yuicy/icons/obj/structures/bdsm_furniture.dmi'
	icon_state = "bdsm_bed"
	max_integrity = 50
...
/obj/structure/chair/x_stand
	...
	var/static/mutable_appearance/xstand_overlay = mutable_appearance('modular_yuicy/icons/obj/structures/bdsm_furniture.dmi', "xstand_overlay", LYING_MOB_LAYER)
