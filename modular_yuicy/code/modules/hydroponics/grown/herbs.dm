/obj/item/seeds/herbs
	...
	icon = 'modular_yuicy/icons/obj/items/food/hydroponics/seeds.dmi'
	...
	potency = 20
	growthstages = 2
	growing_icon = 'modular_yuicy/icons/obj/items/food/hydroponics/growing.dmi'
...
/obj/item/reagent_containers/food/snacks/grown/herbs
	...
	icon = 'modular_yuicy/icons/obj/items/food/hydroponics/harvest.dmi'
	icon_state = "herbs"
	foodtype = VEGETABLES
