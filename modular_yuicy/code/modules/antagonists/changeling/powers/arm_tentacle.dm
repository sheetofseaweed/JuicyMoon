...
/obj/item/arm_tentacle
	...
	icon = 'modular_yuicy/icons/obj/items/arm_tentacle.dmi'
	icon_state = "arm_tentacle"
	item_state = "arm_tentacle"
	lefthand_file = 'modular_yuicy/icons/mob/inhands/arm_tentacle_lefthand.dmi'
	righthand_file = 'modular_yuicy/icons/mob/inhands/arm_tentacle_righthand.dmi'
