...
/obj/structure/tentacle_lair/weeds/Initialize(mapload)
	...
	if(icon == initial(icon))
		switch(rand(1,3))
			if(1)
				icon = 'modular_yuicy/icons/obj/tentacle_lair/tentacle_floor.dmi'
			if(2)
				icon = 'modular_yuicy/icons/obj/tentacle_lair/tentacle_floor2.dmi'
			if(3)
				icon = 'modular_yuicy/icons/obj/tentacle_lair/tentacle_fl_2.dmi'
