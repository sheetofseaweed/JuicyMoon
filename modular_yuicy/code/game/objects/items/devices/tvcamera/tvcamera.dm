/obj/item/tvcamera
	...
	icon = 'modular_yuicy/icons/obj/device/camcorder.dmi'
	mob_overlay_icon = 'modular_yuicy/icons/obj/clothing/worn/belt.dmi'
	lefthand_file = 'modular_yuicy/icons/mob/inhands/lefthand.dmi'
	righthand_file = 'modular_yuicy/icons/mob/inhands/righthand.dmi'
